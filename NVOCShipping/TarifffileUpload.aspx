<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TarifffileUpload.aspx.cs" Inherits="NVOCShipping.TarifffileUpload" %>
    ...
    <form id="form1" runat="server">
       <div>
         ...
         <asp:FileUpload runat="server" ID="ExcelFileUploading" />
           ...
           <asp:Label runat="server" ID="txtDate"></asp:Label>
            </div>
