<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TempCntrMovementUpload.aspx.cs" Inherits="NVOCShipping.TempCntrMovementUpload" %>
                ...
                <div class="col-md-6 col-md-offset-3" style="padding-left:0;padding-right:0;">
                    <div class="panel">
                        <div class="panel-heading" style="background-color:#21277a;text-align:center;color:#fff;">
                            <h4 style="margin-top:0;margin-bottom:0;">Container Movement Upload</h4>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                 ...
                                 <div class="col-md-6" style="text-align:right;">
                                     <asp:Button runat="server" ID="btnfileUploading" Text="File Uploading" OnClick="btnUploadEmail_Click1" />
                                 </div>
                            ...
                            <div class="row" style="margin-top:40px;">
                                <div class="col-md-12" style="text-align:right; margin-top:40px;">
                                    <asp:Button runat="server" ID="btnMoveData" Text="Move To Data" OnClick="btnMove_Click" CssClass="btn btn-primary" />
                                </div>
