<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OnHireUpload.aspx.cs" Inherits="NVOCShipping.OnHireUpload" %>
                ...
                <div class="col-md-6 col-md-offset-3" style="padding-left:0;padding-right:0;">
                    <div class="panel">
                        <div class="panel-heading" style="background-color:#21277a;text-align:center;color:#fff;">
                            <h4 style="margin-top:0;margin-bottom:0;">OnHire Upload</h4>
                        </div>
