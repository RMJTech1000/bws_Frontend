...
{
    public partial class CntrMovementUpload : System.Web.UI.Page
    {
        ...
        protected void btnfileUploading_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string message1 = "Cntr Movement file is missing !!!";
        ...
        private void Import_To_Grid(string FilePath, string Extension,string UserID)
        {
            ...
            DataTable dtx = Manag.InsertCntMovementExcelUploading(dtv, UserID);
