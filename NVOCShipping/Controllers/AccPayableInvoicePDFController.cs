...
namespace NVOCShipping.Controllers
{
    ...
    public class AccPayableInvoicePDFController : Controller
    {
        ...
        public ActionResult InvoicePDF(string idv)
        {
            BindPDF1(idv);
            return View();
        }
        ...
        public void BindPDF1(string idv)
        {
            ...
            if (dtv.Rows.Count > 0)
            {
                ...
                //cb.MoveTo(345, 835);
                //cb.LineTo(345, 600);
                cb.ShowTextAligned(PdfContentByte.ALIGN_CENTER, "PURCHASE INVOICE", 160, 830, 0);
        ...
        {
            string _Query = "Select  Id,InvCusBillingID,NarrationDescription,RatePerUnit,Qty,ROE,LocalAmount,(select top(1) SACCODE from NVO_ChargeTB where ID = NarrationID) as SACCode from NVO_InvoiceVenBillingdtls where InvCusBillingID =" + InvID;
            return Manag.GetViewData(_Query, "");
        }
    }
}